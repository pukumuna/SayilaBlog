...
<head> 
    ...
    <!-- Custom Fonts -->
    <link href="boot/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" >
    ...
    <link href="/css/blogfree.css" rel="stylesheet">
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Mes nouvelles réalisations</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if ( $internaute->isAdministrateur()) { ?>
                        ...
                        <li class="page-scroll">
                           <a href="/admin/news-insert.html">Ajout news</a>
                        </li>
